...
const DEPARTMENTS = ["compliance", "accounting", "audit", "legal", "global"];
      ...
      >
        ...
        >
          ...
          <div style={{ margin: "32px 0 40px" }}>
            ...
            >
              Automated Gap Analysis &amp; Immutable Audit Trails
            </h2>
        ...
        >
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ color: "#64748b", fontSize: "14px", fontWeight: 500 }}>
              Join your organization&apos;s compliance platform
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ position: "relative" }}>
                <span
                  style={{
                    ...
                    top: "50%",
                    transform: "translateY(-50%)",
                    color: focusedField === "email" ? "#e8b84b" : "#94a3b8",
                    display: "flex",
                    transition: "color 0.2s ease",
                  }}
                >
                ...
                <input
                  ...
                  style={{
                    width: "100%",
                    background: "#ffffff",
                    border: focusedField === "email" ? "1px solid #e8b84b" : "1px solid #e2e8f0",
                    borderRadius: "12px",
                    padding: "11px 16px 11px 40px",
                    color: "#2d3142",
                    fontSize: "14px",
                    ...
                    outline: "none",
                    boxShadow:
                      focusedField === "email" ? "0 0 0 4px rgba(232, 184, 75, 0.1)" : "none",
                    transition: "all 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
                    fontFamily: "Inter, sans-serif",
                  }}
                />
            ...
            <div>
              ...
              >
                Full Name <span style={{ color: "#94a3b8", fontSize: "10px", textTransform: "none" }}>(optional)</span>
              </label>
              <div style={{ position: "relative" }}>
                <span
                  style={{
                    ...
                    top: "50%",
                    transform: "translateY(-50%)",
                    color: focusedField === "full_name" ? "#e8b84b" : "#94a3b8",
                    display: "flex",
                    transition: "color 0.2s ease",
                  }}
                >
                ...
                <input
                  ...
                  style={{
                    width: "100%",
                    background: "#ffffff",
                    border: focusedField === "full_name" ? "1px solid #e8b84b" : "1px solid #e2e8f0",
                    borderRadius: "12px",
                    padding: "11px 16px 11px 40px",
                    color: "#2d3142",
                    fontSize: "14px",
                    ...
                    outline: "none",
                    boxShadow:
                      focusedField === "full_name" ? "0 0 0 4px rgba(232, 184, 75, 0.1)" : "none",
                    transition: "all 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
                    fontFamily: "Inter, sans-serif",
                  }}
                />
              ...
              <div style={{ position: "relative" }}>
                <span
                  style={{
                    ...
                    top: "50%",
                    transform: "translateY(-50%)",
                    color: focusedField === "department" ? "#e8b84b" : "#94a3b8",
                    display: "flex",
                    transition: "color 0.2s ease",
                    zIndex: 1,
                    pointerEvents: "none",
                ...
                <CustomSelect
                  ...
                  triggerPadding="11px 16px 11px 40px"
                />
              </div>
            </div>
